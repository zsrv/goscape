...
**Tech Stack:** Go 1.26+ (per `go_version.md`; use `use-modern-go` skill). TS source: `LostCityRS/Engine-TS` only per `ts_source_canonical_path.md`. HEAD baseline: `c15b589` (NAI-41 spec commit).
...
| Check | Command | Expected at HEAD `c15b589` |
|-------|---------|---------------------------|
