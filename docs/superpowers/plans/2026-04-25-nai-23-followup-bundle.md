...
**Reference**: `docs/superpowers/specs/2026-04-25-nai-23-followup-bundle-design.md` (committed at `a2ff50f`).
...
**Resolved 2026-04-24 (NAI-19 Task 3, commit `116b641`).** `n.lookupType(newType)` is
...
**Resolved 2026-04-25 (NAI-21 Bundle 1, commit `fe60baa`).** Both call sites now read
...
changetype`, resolved by NAI-19 Task 3 commit `116b641`) and `nai_followups.md:1272`
(`Promote n.size snapshot to LoS-path reads`, resolved by NAI-21 Bundle 1 commit
`fe60baa`) — plus one stale cross-ref at `:244`. Three stale entries discovered
...
Closes memory: nai_followups.md:786 (Resolved by NAI-19 Task 3, commit 116b641)
Closes memory: nai_followups.md:1272 (Resolved by NAI-21 Bundle 1, commit fe60baa)
