...
**Spec:** `docs/superpowers/specs/2026-05-14-nai-200-compilertypeinfo.md` (commit `1b0b547`).
**HEAD at plan-write:** `1b0b547`.
...
Verified at plan-write against HEAD `1b0b547`:
