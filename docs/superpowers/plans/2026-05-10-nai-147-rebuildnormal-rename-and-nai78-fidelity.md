...
**Pre-flight HEAD:** `58fe41f` (NAI-146 close).
...
- [ ] **Expected: 19 lines** across 5 files (verified at HEAD `58fe41f`):
  ```
...
- [ ] **Expected (4 lines):** `targetOpLocT = 6`, `targetOpNpcT = 8`, `targetOpPlayerT = 10`, `targetOpObjT = 12` (verified at HEAD `58fe41f`).
