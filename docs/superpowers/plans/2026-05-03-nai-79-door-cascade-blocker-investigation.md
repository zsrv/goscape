...
**Spec:** `docs/superpowers/specs/2026-05-03-nai-79-door-cascade-blocker-investigation-design.md` (HEAD `2c0775e`).
...
Stage 1 smoke at HEAD 0a8b43a produced three OPLOC1 receipts (Tutorial
...
**Re-smoke at HEAD `a8687da` (`ea6edcf` instrumentation + `a8687da` docstring polish).** User booted the binary on host, logged in as fresh tutorial-stage character, performed door-cascade probe per spec §7.
...
**Bundle H4 status: CLOSED.** Instrumentation in (`ea6edcf` + `a8687da`); gate signal pinned; routing target confirmed; Stage 2.5 brainstorm seed published above.
