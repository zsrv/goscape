...
Find the row at `docs/PORTING-CLOSED.md:68` (`⚠️ MED ... login-server-9 / gap-db-datastruct-9 ... EXCEPTION-DOCUMENTED fix/med-bundle-19 (44c9b430)`). Change its status cell from `✅ **EXCEPTION-DOCUMENTED** fix/med-bundle-19 (44c9b430)` to `✅ **FIXED** fix/hiscore-port` and append to the row's notes:
