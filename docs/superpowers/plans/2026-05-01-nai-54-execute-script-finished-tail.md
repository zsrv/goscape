...
**Spec:** `docs/superpowers/specs/2026-05-01-nai-54-execute-script-finished-tail-design.md` (commit `0cd3e2e`).

---

## Pre-flight context (verified at HEAD `0cd3e2e`)
...
```
git rev-parse HEAD                        # confirm 0cd3e2e or descendant
