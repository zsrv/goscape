...
**Spec:** `docs/superpowers/specs/2026-05-10-nai-148-server-trigger-string-and-defaultop-name-design.md` (commit `687bc87`).
...
Before dispatching T1, the controller (parent) verifies these premises against HEAD `687bc87`:
