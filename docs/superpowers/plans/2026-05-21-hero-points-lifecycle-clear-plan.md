...
**Spec:** `docs/superpowers/specs/2026-05-21-hero-points-lifecycle-clear-design.md` (committed at `083e6625`).
...
- 5 commits on top of spec commit `083e6625` (Tasks 1-5, one commit each)
