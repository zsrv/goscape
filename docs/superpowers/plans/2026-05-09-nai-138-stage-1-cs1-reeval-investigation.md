...
|------|----------------|--------|
| `docs/superpowers/specs/2026-05-09-nai-138-cs1-reeval-investigation-design.md` | Append Bundle 0 verdict (§6.1, §6.2) and Stage 1 synthesis verdict (§6.3) inline. | Modify (committed at 60ddb73) |
...
The carryover hypothesis (from goscape NAI-137 close commit a169171) asserts
