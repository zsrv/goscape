...
**Spec:** `docs/superpowers/specs/2026-05-20-nai184-combat-level-recompute-design.md` (commit `95e1761c`).

**HEAD at start:** `95e1761c` on top of `45f34867` (handlePWalk port).
...
Run: `git log --oneline 95e1761c..HEAD`

Expected: exactly 5 new commits (T1, T2, T3, T4, T5).

Run: `git log --oneline 45f34867..HEAD`

Expected: 6 commits (the spec commit `95e1761c` + the 5 implementation commits).
