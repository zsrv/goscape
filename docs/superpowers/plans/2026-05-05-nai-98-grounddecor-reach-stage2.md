...
Expected: `280a02a docs(spec): NAI-98 — correct H7 probe algorithm` and `d7294b2 docs(spec): NAI-98 — GroundDecor reach Stage 2 narrow-then-fix` near the top, above `2db2aca chore(close): NAI-97`.
