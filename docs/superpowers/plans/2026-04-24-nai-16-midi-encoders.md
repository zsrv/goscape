...
**Spec:** `docs/superpowers/specs/2026-04-24-nai-16-midi-encoders-design.md` (commits `a4afcc2`, `3f63f6d`).

**Predecessor:** S7i closed at HEAD=`62550dc`. Spec on `main` adds two commits ahead of that.
