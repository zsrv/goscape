...
**Spec:** `docs/superpowers/specs/2026-04-25-nai-20-followup-bundle-design.md` (commit `f06ae2d`).

**Predecessor HEAD:** `1b52859` (NAI-19 closed).
...
1. **Stage 1 — code quality**: `superpowers:code-reviewer` on the full diff `1b52859..HEAD`. Focus: dead code, unused imports, comment freshness, helper API ergonomics, test redundancy.
