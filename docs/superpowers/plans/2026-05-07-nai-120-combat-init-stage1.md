...
**Predecessor:** NAI-119 close commit `0e8ffc5`; smoke residual #2 ("no handler for MAP_MULTIWAY (opcode 1014)" at pc=1 of `[proc,player_in_combat_check]` when attacking tutorial rats).
...
| Item | Status at HEAD 0e8ffc5 | Evidence |
|---|---|---|
...
**Date:** 2026-05-07
**Spec:** `docs/superpowers/specs/2026-05-07-nai-120-combat-init-path-investigation-design.md` (commit `27203f7`)
**HEAD at pre-flight:** `0e8ffc5` (NAI-119 close)
...
0e8ffc5; classified W/D/U/P-in-ring/F per spec §4.2.
