...
NAI-155 (commit `f2bdcb1`) retired the **player-path** NAI-44 retention at
...
| Player-side NAI-155 fix landed at HEAD | ✅ confirmed at commit `f2bdcb1`; `script.go:148` has `self.ClearActiveScript()` |
