...
**Spec:** `docs/superpowers/specs/2026-05-09-nai-144-queueengine-wiring-design.md` (committed at `8554a73`).
...
Expected: PASS (all existing tests green at HEAD `8554a73`).
...
```go
	...
	// assignment sites (verified at HEAD `8554a73`). TS sets it in
...
Expected: 4 NAI-144 commits + earlier `8554a73` spec commit.
