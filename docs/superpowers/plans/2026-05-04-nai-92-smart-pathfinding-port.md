...
**Spec:** `docs/superpowers/specs/2026-05-04-nai-92-smart-pathfinding-port-design.md` (committed at `8221d39`).

**Predecessor close:** NAI-91 (commit `88699f3`) — closed door re-click reach gate; left Survival Expert NPC unreachable per §10 deferral, routed to NAI-92.
