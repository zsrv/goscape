...
**Pre-flight context:**
- HEAD `3ad1190` (after spec commit). The 1-line fix is at `handlers_inv.go:429`. Verify line numbers re-grep at task time per `controller_preflight` memory.
...
at handlers_inv.go:429 was passing source=-1 (origin commit fa57ee4
