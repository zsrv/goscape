...
**Spec:** `docs/superpowers/specs/2026-05-10-nai-149-trivial-handler-sweep-design.md` (commit `88a26f7`).
...
Before dispatching T1, the controller (parent) verifies these premises against HEAD `88a26f7` (per `controller_preflight.md`):
...
```
Expected: 39 (down from 47 at HEAD `f884a93`).
