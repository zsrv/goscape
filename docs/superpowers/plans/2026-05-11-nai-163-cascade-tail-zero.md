...
**Source-of-truth pinning at HEAD `d865ba1`:**
...
- Spec: `docs/superpowers/specs/2026-05-11-nai-163-cascade-tail-zero-design.md` (committed at `3bff22b`).
...
missing_handler_audit_regex_flaw.md:
  ...
  Pre-NAI-163 (at d865ba1): 4 opcodes (OpBusy, OpLineOfSight,
                            OpNpcAdd, OpNpcHunt)
  Post-NAI-163:              0
