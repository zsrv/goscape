...
**Spec:** `docs/superpowers/specs/2026-05-11-nai-165-low-arg-shape-fix-design.md` (commit `afce4ed`).

**HEAD at plan-write:** `afce4ed`.
...
NAI-165 spec at `docs/superpowers/specs/2026-05-11-nai-165-low-arg-shape-fix-design.md` (commit `afce4ed`); plan at `docs/superpowers/plans/2026-05-11-nai-165-low-arg-shape-fix.md`. Closed at `<COMMIT-SHA>` (single TDD commit).
