...
**Spec:** `docs/superpowers/specs/2026-05-13-nai-194-param-packer-design.md` (commit `c9d549b`).
**HEAD at plan-write:** `c9d549b`.
...
Verified at plan-write against HEAD `c9d549b`:
