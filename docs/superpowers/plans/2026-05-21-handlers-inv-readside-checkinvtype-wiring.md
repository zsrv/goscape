...
**Spec:** `docs/superpowers/specs/2026-05-21-handlers-inv-readside-checkinvtype-wiring-design.md` (HEAD `dc8c3d8b`).
...
Audit-grep delta vs HEAD dc8c3d8b:
