...
**Predecessor:** slice 7 close commit `c9515d25`; spec commit `e448264e` at `docs/superpowers/specs/2026-05-20-friends-public-chat-followup-design.md`.
