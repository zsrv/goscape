...
**Spec:** `docs/superpowers/specs/2026-05-08-nai-124-damage-magnitude-investigation-design.md` (commit `83e9016`).

**Predecessor:** NAI-123 close commit `df95032`; residual #1 carry-forward (NAI-123 §7).
...
Expected: top line `83e9016 spec(nai-124): damage magnitude investigation — pre-cap input reads huge`. Second line `df95032 chore(close): NAI-123 …`.
...
**Date:** 2026-05-08
**Spec:** `docs/superpowers/specs/2026-05-08-nai-124-damage-magnitude-investigation-design.md` (`83e9016`)
...
Capture the full list. Already-known fixed sites (per NAI-122 `4c49c51`): `pkg/script/handlers_config.go:38` (paramLookup set branch), `pkg/script/handlers_inv.go:249` (INV_TOTALPARAM), `modules/world/npc_hunt.go:291` (sumPlayerInvParam).
...
**Sites already fixed by NAI-122 4c49c51:** <list with line refs>.
...
- Spec: `docs/superpowers/specs/2026-05-08-nai-124-damage-magnitude-investigation-design.md` (`83e9016`).
- NAI-123 close: `df95032` (smoke that surfaced this residual).
- NAI-122 set-branch sign-ext fix: `4c49c51`.
