...
**Tech Stack:** Go 1.26+ (per `go_version.md`; use `use-modern-go` skill). TS source: `LostCityRS/Engine-TS` only per `ts_source_canonical_path.md`. HEAD baseline: `7576023` (NAI-42 spec commit).
...
| Check | Command | Expected at HEAD `7576023` |
|-------|---------|----------------------------|
