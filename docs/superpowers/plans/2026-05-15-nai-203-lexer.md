...
**Tech Stack:** Go 1.26+, stdlib `testing` only (no testify), `slices.Clone`/`slices.Concat`. No new external deps. TS source-of-truth: `$HOME/Code/github.com/LostCityRS/RuneScriptTS` at HEAD `b8c338801fbb72d294ff9576a58925a8d3f6de47`.
...
- All file paths absolute or rooted at `$HOME/Code/github.com/zsrv/goscape/`.
...
(Exact copy of `$HOME/Code/github.com/neptune-ps/neptune/runescript-parser/src/test/resources/me/filby/neptune/runescript/parser/script.src`.)
