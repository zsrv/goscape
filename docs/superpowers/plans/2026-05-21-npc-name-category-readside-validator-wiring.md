...
**Spec:** `docs/superpowers/specs/2026-05-21-npc-name-category-readside-validator-wiring-design.md` (HEAD `d9fc8fab`).
...
deferred by predecessor c8654020. Wires checkNpcType + requireConfigs at
...
validator-wiring-design.md (d9fc8fab).
