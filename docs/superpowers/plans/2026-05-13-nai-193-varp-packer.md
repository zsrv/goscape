...
**Spec:** `docs/superpowers/specs/2026-05-13-nai-193-varp-packer-design.md` (commit `77ee674`).
**HEAD at plan-write:** `77ee674`.
...
Verified at plan-write against HEAD `77ee674`:
