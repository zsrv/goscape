...
**Spec:** `docs/superpowers/specs/2026-05-16-nai-210-fu-richer-driver-smoke-design.md` (committed at `3e1aa36`).

**Pre-flight state (HEAD `3e1aa36`):**
...
Current imports (HEAD `3e1aa36`) are `"os"`, `"path/filepath"`, `"testing"`, plus internal `semantics` import. Add `"encoding/binary"` as the first import in the stdlib group.
