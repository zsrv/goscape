...
**Spec:** `docs/superpowers/specs/2026-05-08-nai-130-inv-add-stackable-overflow-design.md` (commit `1077627`).
...
- [ ] If the reviewer flags critical issues, address inline as a reviewer-fix sub-commit before the close commit. Path matches NAI-123 reviewer-fix pattern (`5992d9b`).
