...
**Spec:** `docs/superpowers/specs/2026-05-03-nai-83-loc-angle-port-design.md` (committed `08aebae`).
...
**Per `compressed_cadence.md` 15–100 LOC band:** dispatch ONE reviewer subagent against the cumulative diff `08aebae..HEAD` (spec→impl range), not per-task reviewers.

**Reviewer prompt template (subagent):**

> Review the implementation of NAI-83 (LOC_ANGLE opcode port). Spec at `docs/superpowers/specs/2026-05-03-nai-83-loc-angle-port-design.md` (commit `08aebae`). Plan at `docs/superpowers/plans/2026-05-03-nai-83-loc-angle-port.md`. Cumulative diff: `git diff 08aebae..HEAD`.
>
