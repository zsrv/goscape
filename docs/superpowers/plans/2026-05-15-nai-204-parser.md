...
**Tech Stack:** Go 1.26+, stdlib `testing` only (no testify), `slices.Clone`/`slices.Concat`. No new external deps. Lexer dep is NAI-203's `pkg/pack/compiler/lexer`. TS source-of-truth: `/home/owner/Code/github.com/LostCityRS/RuneScriptTS` at HEAD `b8c338801fbb72d294ff9576a58925a8d3f6de47` (same pin as NAI-203).
