...
After NAI-114 Stage 2 (commits `bec93b8`, `9ffa897`, `1ea166d`) shipped the MAP_LOCADDUNSAFE port — TS-faithful, 12 unit tests, full suite green — the user-launched smoke shows **no observable change**:
