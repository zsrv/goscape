...
- **USER_EVENT**: `MOVE_GAMECLICK`, `MOVE_OPCLICK`, `MOVE_MINIMAPCLICK`, all `OPxxx` interaction packets (OPOBJ, OPNPC, OPLOC, OPPLAYER, OPHELD, INV_BUTTON, IF_BUTTON, RESUME_*, CLOSE_MODAL, MESSAGE_PUBLIC, MESSAGE_PRIVATE, etc.)
- **RESTRICTED_EVENT**: `CLIENT_CHEAT`
- **CLIENT_EVENT**: everything else (anticheat, camera, event tracking, keepalive)
