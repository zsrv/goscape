...
**Cascade-tail context:** missing-handler audit at HEAD `c0e8245` reports **28 unhandled opcodes** (`missing_handler_audit.md` one-liner). This sub-spec ports 7; remaining 21 stay forward-routable to NAI-161+.
