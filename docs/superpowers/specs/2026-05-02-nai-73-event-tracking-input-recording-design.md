...
**Predecessor:** NAI-72 (HEAD `5e09063`). Net deviation tally entering: 18.
**Closes:** 2 deviations:
...
## 2. Current state at HEAD (`5e09063`)
...
Per `controller_preflight.md`: any premise that surfaces wrong gets fixed in the spec via inline erratum (matches NAI-72's `c8e995c` STAFFMODLEVEL retraction pattern) before plan-author dispatch.
