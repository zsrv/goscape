...
**Cascade-tail context:** missing-handler audit at HEAD 0a5085c reports **47 unhandled opcodes** (`missing_handler_audit.md` one-liner). This sub-spec ports 8; remaining 39 stay forward-routable to NAI-150+.
