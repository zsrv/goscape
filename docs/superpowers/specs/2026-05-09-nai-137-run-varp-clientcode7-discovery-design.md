...
**Status:** spec
**Date:** 2026-05-09
**Predecessors:** NAI-136 (runweight propagation) closed at `3151cc0`. NAI-135 carryover queue (line 6423 of `nai_followups.md`) named this candidate verbatim: "run-toggle UI varp UI-binding."
**Tech stack:** Go 1.26+
