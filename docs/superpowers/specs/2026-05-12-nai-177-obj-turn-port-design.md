...
Go 1.26+ (per `go_version.md`). Sources of truth pinned at HEAD `9d0ccc6`:
...
## §2. Existing goscape state (HEAD `9d0ccc6`)
...
`rg "NAI-115-D2" pkg/ modules/` enumeration at HEAD `9d0ccc6` (verified):
...
- [x] All line numbers verified at HEAD `9d0ccc6`.
