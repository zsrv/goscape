...
**Predecessor**: NAI-82 (HEAD `592ef19` — P_ARRIVEDELAY ported; door-click smoke
...
at `:971-972` but has no dispatch wiring. NAI-82's close smoke (HEAD `592ef19`,
...
### 5.3 Pre-flight verification (confirmed against HEAD `592ef19`)
