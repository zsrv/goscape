...
**Predecessor**: NAI-107 (HEAD `5aa3e18` — `handleLcName` Name → DebugName → "null" chain).
...
- **R7 (low) — Spec table line numbers drift between spec-write and impl-dispatch.** Standard `controller_preflight` protocol catches at plan-write. All cited line numbers verified at HEAD `5aa3e18`.
