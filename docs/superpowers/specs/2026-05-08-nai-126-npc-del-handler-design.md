...
**Status:** spec — draft 1
**Date:** 2026-05-08
**Predecessor:** NAI-125 close (`6d04cf8`); cascade-bound to the `[proc,npc_death]` smoke surfaced by NAI-125 close (2026-05-08).
...
**Smoke (NAI-125 close, `6d04cf8`, 2026-05-08):**
...
In `pkg/objtype/paramtype_test.go` — new file (verified absent at HEAD `6d04cf8`):
