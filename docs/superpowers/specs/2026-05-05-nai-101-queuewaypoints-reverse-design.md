...
Bundle 0 probe at HEAD `d58a60f` (post-NAI-100) **falsifies all three suspects** and surfaces the actual root cause downstream of the pathfinder.
...
- Smoke binary built before NAI-100 close commit `d58a60f` (timing not verified).
