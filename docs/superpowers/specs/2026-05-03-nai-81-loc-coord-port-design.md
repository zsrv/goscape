...
**Predecessor**: NAI-80 (smoke at HEAD `0a6329f` advanced cascade to `script_dispatch`; LOC_COORD identified as next stub-not-completed)
...
### 5.3 Pre-flight verification (confirmed against HEAD `0a6329f`)
