...
Per memory `tracker_entry_framing_can_be_incomplete` and `risk_register_premise_grep`, every premise below was re-verified against HEAD `dcb13a7`.
...
### §3.2 goscape `tickRate` references at HEAD `dcb13a7`
