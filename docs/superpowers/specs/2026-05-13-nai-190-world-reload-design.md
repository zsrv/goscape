...
Per memory `controller_preflight` and `risk_register_premise_grep`, every premise below was re-verified against HEAD `01a2712`.
...
### §3.2 goscape registry shape at HEAD `01a2712`
