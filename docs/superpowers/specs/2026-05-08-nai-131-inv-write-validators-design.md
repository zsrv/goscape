...
**Status:** spec
**Date:** 2026-05-08
**Predecessor:** NAI-130 close (`8baf2dd`) deferred-omissions §6 — five TS validators omitted from `handleInvAdd` per NAI-130 scope decision. Audit-first determined the same gates are missing across most goscape `INV_*` write handlers, so NAI-131 sweeps the family.
**Tech stack:** Go 1.26+
