...
**Status:** spec — draft 1
**Date:** 2026-05-08
**Predecessor:** NAI-126 close (`1130998`); cascade-bound to the Tutorial-Island giant-rat smoke surfaced at NAI-126 close (2026-05-08).
...
**Smoke (NAI-126 close, `1130998`, 2026-05-08):**
...
**Audit at HEAD (`1130998`)** per `missing_handler_audit`:
...
| # | Item | Pre-NAI-127 (`1130998`) | Post-NAI-127 expected | Binding? |
|---|---|---|---|---|
