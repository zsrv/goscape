...
**Status:** spec — draft 1
**Date:** 2026-05-08
**Predecessor:** NAI-123 close (`b7c16b0`); residual #1 carry-forward (NAI-123 §7).
...
- NAI-122 close commit `2cdeeb9` body explicitly flags the DecodeParams uint32-storage boundary as a future audit ("Future audit should consider fixing at the boundary (DecodeParams stores int32 instead of uint32)").
...
**Probe:**
- `rg "Params\[" pkg/ modules/` at HEAD; cross-reference each site against NAI-122 `92ca5c4` diff.
...
- NAI-122 close commit: `2cdeeb9`. NAI-122 sign-ext fix: `92ca5c4`. NAI-123 close commit: `b7c16b0` (smoke that surfaced this residual).
