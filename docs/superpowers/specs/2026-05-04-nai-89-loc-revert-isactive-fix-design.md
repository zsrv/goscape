...
**Status:** Spec
**Date:** 2026-05-04
**Predecessor:** NAI-88 (Stage 1 lifecycle-revert probe scaffold; closed at HEAD `c46f0e3`)
...
This test fails on HEAD `c46f0e3` (case-3 AddLoc fires; loc remains changed). It passes after Bundle 1.
