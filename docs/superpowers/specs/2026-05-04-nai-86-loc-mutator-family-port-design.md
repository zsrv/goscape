...
**Predecessor**: NAI-85 (HEAD `e1f7f27` — LOC_PARAM/NAME/TYPE/SHAPE
active-loc readers ported; door-click LOC_PARAM cascade-blocker
silenced).
**Smoke binding (post-NAI-85)**: door-click smoke at HEAD `e1f7f27`
...
Tutorial Island door-click smoke at HEAD `e1f7f27` reveals
