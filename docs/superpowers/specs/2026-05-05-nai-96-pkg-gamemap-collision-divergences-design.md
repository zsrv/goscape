...
**Tech stack:** Go 1.26+.
**Parent:** NAI-95 — `docs/superpowers/specs/2026-05-05-nai-95-static-loc-collision-fix-design.md` (closed `55ae182`); user-launched smoke 2026-05-05 surfaced these residuals.
...
Plan-author re-greps these line numbers at HEAD pre-dispatch per `controller_preflight` (NAI-95 close commit `55ae182` may have shifted them; the current spec captures them as of post-NAI-95).
