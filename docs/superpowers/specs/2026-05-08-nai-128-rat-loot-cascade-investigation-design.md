...
**Status:** spec — draft 1
**Date:** 2026-05-08
**Predecessor:** NAI-127 close (`41669e3`); investigates item 2 of NAI-127's smoke matrix (rat death-loot drop FAIL with no new unhandled-opcode WARN).
...
**Smoke (NAI-127 close, `41669e3`, 2026-05-08):**
...
**Static disasm at HEAD `41669e3`** (per `disasm_reframes_inferred_binding`):
