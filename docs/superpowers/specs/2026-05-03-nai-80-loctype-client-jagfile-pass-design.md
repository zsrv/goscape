...
**Predecessor:** NAI-79 Bundle H4 close (commit `604cdb7`) pinned 3/3 Tutorial-Island OPLOC1 clicks (door 3014, bookcase 380, drawer 350) to gate `op_slot_empty`. NAI-80 is the routed Stage 2.5 fix.
...
8. **T8 — Smoke handoff.** Close commit body cites `Closes memory: nai80_seed_loctype_op_empty.md` and the predecessor's H4 commit (`604cdb7`). Hand off smoke task to user with the script in §7.3.
