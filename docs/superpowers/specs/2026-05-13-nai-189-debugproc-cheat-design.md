...
Per memory `controller_preflight` and `risk_register_premise_grep`, every premise below was re-verified against HEAD `d574942`.
...
### §3.2 goscape primitives at HEAD `d574942`
