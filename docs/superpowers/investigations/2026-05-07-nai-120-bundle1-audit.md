...
**Date:** 2026-05-07
**Input:** Bundle 0 findings — `docs/superpowers/investigations/2026-05-07-nai-120-bundle0-findings.md` (commit `24bf569` per spec §4.5 / e2d1803 HEAD-at-pre-flight)
...
3. **Before `npc_statadd`/`npc_statsub`:** Grep `pkg/script/handlers_npc.go` for any partial `handleNpcStatAdd` or `handleNpcStatSub` implementation that may have been added since `e2d1803`. Merge rather than duplicate if found.
