...
**Plan:** `docs/superpowers/plans/2026-05-07-nai-120-combat-init-stage1.md` (commit `854a8a6`)
**HEAD at pre-flight:** `854a8a6` (≡ `a042d2b` for code-content; only docs added since NAI-119 close)
...
| Item | Status at HEAD `854a8a6` | Evidence |
|---|---|---|
