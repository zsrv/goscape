...
- `pkg/script/handlers_config.go:51` — `s.PushInt(int(pt.DefaultInt))` with NO `int32` cast. Set branch at `:43` IS sign-extended (`int(int32(iv))` per NAI-122 `4c49c51`); default branch is not.
...
- `pkg/script/handlers_config.go:31-43` (paramLookup set branch) — NAI-122 `4c49c51` fixed via `int(int32(iv))`.
...
- Bronze dagger (right hand): `param=strengthbonus,3` per `Content/scripts/skill_combat/configs/melee/daggers.obj:30`. Set branch (NAI-122 `4c49c51` sign-ext fixed): contributes +3.
...
- Spec: `docs/superpowers/specs/2026-05-08-nai-124-damage-magnitude-investigation-design.md` (`83e9016`).
- Plan: `docs/superpowers/plans/2026-05-08-nai-124-damage-magnitude-stage1.md` (`d06ca66`).
- NAI-123 close: `df95032` (smoke that surfaced this residual).
- NAI-122 set-branch sign-ext fix: `4c49c51`.
- NAI-122 close: `9ebd2ed` (flagged DecodeParams uint32-storage as future audit).
