...
var (
	...
	ServerTriggerApNpc1 = &TriggerType{
		ID:          3,
		Identifier:  "apnpc1",
		SubjectMode: NewModeType(typ.ScriptVarNpc, false, false),
	...
	ServerTriggerApObj1 = &TriggerType{
		ID:          31,
		Identifier:  "apobj1",
		SubjectMode: NewModeType(typ.ScriptVarNamedObj, false, false),
	...
	ServerTriggerApLoc1 = &TriggerType{
		ID:          59,
		Identifier:  "aploc1",
		SubjectMode: NewModeType(typ.ScriptVarLoc, false, false),
	...
	ServerTriggerIfClose = &TriggerType{
		ID:          148,
		Identifier:  "if_close",
		SubjectMode: NewModeType(typ.ScriptVarInterface, false, false),
		Pointers:    pointer.NewPointerSet(pointer.ActivePlayer),
	}
	...
	ServerTriggerAdvanceStat = &TriggerType{
		...
		SubjectMode: NewModeType(typ.ScriptVarStat, false, false),
		Pointers:    pointer.NewPointerSet(pointer.ActivePlayer, pointer.PActivePlayer),
	}
	...
	ServerTriggerMapZone = &TriggerType{
		ID:          161,
		Identifier:  "mapzone",
		SubjectMode: NewModeType(typ.PrimitiveMapzone, false, false),
		Pointers:    pointer.NewPointerSet(pointer.ActivePlayer, pointer.PActivePlayer),
	}
	...
	ServerTriggerZone = &TriggerType{
		ID:          163,
		Identifier:  "zone",
		SubjectMode: NewModeType(typ.PrimitiveCoord, false, false),
		Pointers:    pointer.NewPointerSet(pointer.ActivePlayer, pointer.PActivePlayer),
	}
