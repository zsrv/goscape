...
// see that the PACKER changed. The rev-274 engine sync (2026-08-31) moved npc
// wanderrange/maxrange to opcodes 26/27 and extracheck_var to 19-21; a plain
// `make pack` afterwards left 2,909 artifacts unrebuilt, including a hunt.dat
// still carrying pre-sync opcodes from June. The server then refused to boot
// on the loud path and would have served wrong bytes on the quiet one.
//
...
// History:
//
//	1 — initial, at Engine-TS 1d25566c / Content 2b62ae68d.
