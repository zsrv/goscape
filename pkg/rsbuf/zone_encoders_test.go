...
// exactly the drift it claimed to pin: the 245.2 wire renumber updated the
// prot table, this fork kept the 244 bytes, the test kept passing, and the
// live client smoke found doors not opening (zone deltas undecodable by the
// 245.2 client until a level change forced a full rebuild).
