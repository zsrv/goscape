...
// category via CategoryTypeValid.
// checkCategoryType validates against Configs.CategoryType — mirrors TS
// InvOps.ts:638 check(category, CategoryTypeValid) (ScriptValidators.ts:123).
