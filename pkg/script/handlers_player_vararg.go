...
// handleStrongQueueVarArg implements STRONGQUEUEVARARG (opcode 2135):
...
// handleWeakQueueVarArg implements WEAKQUEUEVARARG (opcode 2134):
...
// handleQueueVarArg implements QUEUEVARARG (opcode 2132): identical
...
// handleLongQueueVarArg implements LONGQUEUEVARARG (opcode 2133):
