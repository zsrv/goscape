...
CROSS_BUILD_BINARIES ?= goscape goscape-cli
...
# Usage:
#   make dist/goscape-linux-amd64                 # build a single binary
#   make cross-build                              # build all combinations
#   make cross-build CROSS_BUILD_PLATFORMS="linux/amd64 darwin/arm64" CROSS_BUILD_BINARIES="goscape goscape-cli"
