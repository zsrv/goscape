...
// == "") now fails; NewDefaultConfig applies
// RegisterFlagsAndApplyDefaults first, which gives Database.Backend its
// "sqlite" default (database module, task 3).
// COV-1 (Arc 18).
