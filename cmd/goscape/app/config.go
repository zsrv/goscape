...
//
// Database, Login, Friends, OnDemand, Telemetry, and PacketCapture's own
// Validate errors already self-prefix ("database: ...", "login: ...",
// "friends: ...", "ondemand: ...", "telemetry: ...", "packetcapture: ..."),
// so they're returned unwrapped here to avoid a doubled prefix. World's
// Validate instead uses flag-style prefixes (e.g. "world.tcp-listen-port"),
// so it still needs the "world: " wrap added here.
//
