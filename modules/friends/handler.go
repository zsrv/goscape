...
// @3c16994c: both endpoint accounts are resolved against the central
...
// FriendServer.ts:291-306 @3c16994c — append-only, no delivery, no
...
// session_uuid (docs/superpowers/sdd/audit-port2452.md "Deltas vs
// rev-274" (2)).
//
