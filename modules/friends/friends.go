...
// central database, the gRPC server, and the per-profile repository
// registry.
type Friends struct {
	services.Service
...
func NewFriendsService(cfg Config, dbCfg gamedb.Config, logger *slog.Logger) (services.Service, error) {
