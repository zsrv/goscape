...
// FriendServer.ts:260-290 @9aadcec4: resolve from/to via
...
// FriendServer.ts:291-306 @9aadcec4: `const from = await
...
// docs/superpowers/sdd/audit-port244.md "Deltas vs rev-274" (2)),
// rev-244's OWN pin (9aadcec4) still carries this older
// account_id/profile/world shape — byte-identical to rev-245.2's pin
// (3c16994c) on this surface, per the audit's headline finding — which
// this branch's gamedb schema (pkg/gamedb/migrations/*/000001_init.up.sql)
// already provisions.
//
