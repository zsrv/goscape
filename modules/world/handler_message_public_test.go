...
// public_chat (World.ts:1620-1628 logPublicChat @9aadcec4). Chat is
...
func TestHandleMessagePublic_EmitsPublicChatEvent(t *testing.T) {
	...
	if got.SessionUuid != "uuid-sess-1" {
		t.Errorf("SessionUuid: got %q, want uuid-sess-1 (p.session; TS World.ts:1620-1628 @9aadcec4)", got.SessionUuid)
	}
