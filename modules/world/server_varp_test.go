...
// 2e3bcf43 (254 pin-advance): the NPCCOUNT/ZONECOUNT/LOCCOUNT/OBJCOUNT
// script ops were deleted upstream — the worldVarsView Total* wrappers and
// their tests left with them (Server.npcs and pkg/zone counts remain).
