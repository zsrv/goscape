...
// port (Engine-TS@9aadcec4 PathingEntity.ts:163-188): an entity's collision
...
// TestPlayerStepThenLogout_CollisionSeedBalance: per TS@9aadcec4 there is NO
...
func TestPlayerStepThenLogout_CollisionSeedBalance(t *testing.T) {
	...
	// no changeNpcCollision in its player-add path at 9aadcec4).
	if s.gamemap.Pathfinder.Flags.IsFlagged(3200, 3200, 0, collision.FlagBlockNPCs) {
