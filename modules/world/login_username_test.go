...
// docs/superpowers/specs/2026-07-07-chat-kafka-only-design.md) can key on
// the per-login UUID. The whole-slice review for slice 7 noted that only
// the world-side e2e covered this — this direct unit test fills the gap.
