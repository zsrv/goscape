...
func (n *Npc) Teleport(x, z, level int) {
	...
	// PathingEntity.ts:290 → refreshZonePresence(:160-185).
...
func (s *Server) resumeOrFinishNpc(state *script.ScriptState, npc script.ActiveNpc) {
	...
	default:
		...
		// protect-cleanup tail at Npc.ts:230-237 runs after this switch — see
	...
	// TS Npc.executeScript tail (Npc.ts:230-237 @e1dea19f): release protected
