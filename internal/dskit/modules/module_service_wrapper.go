...
func newModuleServiceWrapper(serviceMap map[string]services.Service, mod string, logger *slog.Logger, modServ services.Service, startDeps []string, stopDeps []string) services.Service {
