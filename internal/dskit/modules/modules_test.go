...
func TestDependencies(t *testing.T) {
	...
	mm := NewManager(slog.New(slog.DiscardHandler))
...
func TestRegisterModuleDefaultsToUserVisible(t *testing.T) {
	sut := NewManager(slog.New(slog.DiscardHandler))
...
func TestModuleService_InterruptedFastStartup(t *testing.T) {
	...
	moduleSvc := NewModuleService("A", slog.New(slog.DiscardHandler), subService, noDepsFunc, noDepsFunc)
